...
\hspace{-0.6cm}\includegraphics[width=0.6\textwidth]{logo_polimi_ing_indinf_neg.eps}
...
\vspace{-0.4cm}
\fontsize{0.3cm}{0.5cm}\selectfont \bfseries Co-advisor: \textbf{\firstcoadvisor}\\
