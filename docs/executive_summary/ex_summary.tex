...
Nevertheless, as shown in Figure~\ref{fig:matmul-opts-comparison}, using external memory still impacts the number of cycles for the accelerator due to a change in its structure.
